  ...
  return (
    <div className="mt-5 mx-auto max-w-4xl bg-gray-50 p-8 mb-10 rounded-lg shadow-md">
      <h1 className="text-4xl text-blue-800 font-extrabold font-sans py-4 text-center">
        <ins>Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</ins>
      </h1>
      ...
      <div className="flex mt-8 gap-6 justify-center flex-wrap">
        <button className="text-white bg-blue-600 hover:bg-blue-700 font-semibold text-base py-2 px-6 rounded-full shadow-md transition-transform duration-300 ease-in-out transform hover:scale-105">
          Book a Test Drive
        </button>
        <button className="text-blue-600 hover:bg-blue-600 hover:text-white font-semibold text-base py-2 px-6 rounded-full shadow-md border-2 border-blue-600 transition-transform duration-300 ease-in-out transform hover:scale-105 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm mt-4 text-gray-700">
        ...
        <div><strong>Engine:</strong> 1498 cc</div>
