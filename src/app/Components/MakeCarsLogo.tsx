...
export default function MakeCarsLogo (){
    return (
        <div>
             <div className="flex px-32 py-2 justify-start w-full bg-gray-300 cursor-pointer">
                <h1 className="text-2xl font-sans font-semibold text-black">New Cars by Make</h1>
            </div>
